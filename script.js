...
.page {
    ...
    transform-origin: left center;
    transform-style: preserve-3d;
    /* ПЛАВНОЕ, МЕДЛЕННОЕ ПЕРЕЛИСТЫВАНИЕ (1.8s) */
...
.page .front, .page .back {
    ...
    background: #ffffff;
    box-shadow: inset 4px 0 10px rgba(0,0,0,0.05), 0 0 20px rgba(255, 255, 255, 0.2);
    padding: 10px;
...
/* СТИЛЬ ПИШУЩЕЙ МАШИНКИ ДЛЯ ТЕКСТА КНИГИ */
.page-footer { 
    font-family: 'Courier New', Courier, monospace !important;
    font-size: 14px; 
    font-weight: bold; 
    color: #db2777; /* Розовый цвет текста */
    text-align: center; 
    min-height: 3.5em; /* Резервируем место, чтобы верстка не прыгала */
    white-space: pre-wrap; /* Красивый перенос по словам */
    display: flex;
    align-items: center;
    justify-content: center;
}
