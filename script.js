let bookStep = 0;
// Изменено на 10 листов (20 страниц)
const TOTAL_PAGES = 10;

// НАСТРОЙКА ТЕКСТОВ ДЛЯ СТРАНИЦ КНИГИ (Все 10 разворотов)
const TEXTS = {
    ...
    p7Front: "Пусть впереди будет еще больше ярких красок! 🎨",
    p7Back: "И пусть наша радость не знает границ! 🚀",
    p8Front: "Твоя улыбка освещает всё вокруг! 🌞",
    p8Back: "Каждый момент с тобой — это праздник! 🎊",
    p9Front: "Самые красивые страницы этой книги уже написаны. Но самые счастливые страницы нашей жизни еще впереди! 🌸",
    p9Back: "Спасибо тебе что ты есть в моей жизни. Біздің махаббат хикаямыз енді ғана басталады...! 💗",
    p10Front: "Я люблю Тебя.❤️",
    p10Back: " HAPPY BIRTHDAY BALAPAN🎉❤️"
};
...
// Логика последовательного перелистывания 10 листов книги
