...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const countdownInterval = setInterval(() => {
        ...
        if (count > 0) {
            ...
            setTimeout(() => {
                if (targetTextElement) targetTextElement.innerHTML = "H A P P Y";
            }, 1500);
            ...
            setTimeout(() => {
                if (targetTextElement) targetTextElement.innerHTML = "T O";
            }, 3500);
            ...
            // Переход к книге через 6.5 секунд после появления первого слова
            setTimeout(() => {
